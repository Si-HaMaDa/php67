...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-8">
            ...
            if (!$id) header('location: blogs.php');

            $blog = $conn->query("SELECT * FROM blogs WHERE id=$id");
            $blog = $blog->fetch();

            if (!$blog) header('location: blogs.php');
            ...
            <article>
                ...
                <figure class="mb-4"><img class="img-fluid rounded" src="<?= !empty($blog['image']) ? "admin/images/blogs/" . $blog['image'] : "https://dummyimage.com/700x350/dee2e6/6c757d.jpg" ?>" alt="..." /></figure>
                <!-- Post content-->
                <section class="mb-5">
                    <p class="fs-5 mb-4">
                        <?= $blog['content'] ?>
